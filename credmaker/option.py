...
manual = input("Type <manual> without the <> if you want to configure manually. If you want to automatically configure type <auto> with the <>\n")
...
if manual.lower() == "auto":
    ...
    print("Please try again with auto or manual.")
    exit()
